 ...
 * Comparable接口的方式一旦一定，保证Comparator接口实现类的对象在任何位置都可以比较大小
...
public class CompareTest {
     ...
     * 1.像String、包装类等实现了Comparable接口，重写了compareTo（obj）方法，给出了两个对象大小的方式、
     * 2.像String、包装类重写compareTo()方法以后，进行了从小到大的排列
     * 3.重写compareTo（obj）的规则：
     * 如果当前对象this大于形参对象obj,则正常返回正整数，
     ...
     * 或者实现了java.lang.Comparable接口的排序规则不合适当前的操作，
